...
namespace Client.WcfServiceReference {
    ...
    public interface IService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService/GetAllDocumentsByUserId", ReplyAction="http://tempuri.org/IService/GetAllDocumentsByUserIdResponse")]
        Client.WcfServiceReference.ServiceDocument[] GetAllDocumentsByUserId(int userId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService/GetDocumentContent", ReplyAction="http://tempuri.org/IService/GetDocumentContentResponse")]
    ...
    public partial class ServiceClient : System.ServiceModel.ClientBase<Client.WcfServiceReference.IService>, Client.WcfServiceReference.IService {
        ...
        public Client.WcfServiceReference.ServiceDocument[] GetAllDocumentsByUserId(int userId) {
            return base.Channel.GetAllDocumentsByUserId(userId);
        }
        
        public string GetDocumentContent(string path) {
            return base.Channel.GetDocumentContent(path);
        }
    }
}
